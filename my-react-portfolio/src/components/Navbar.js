    ...
    return ( 
        <div>
            <div className="navbar-container">
                <NavLink activeClassName="active" className={splitLocation[1] === "" ? "active" : ""} to="/home"><h4 className="nav-link hover-underline-animation">Home</h4></NavLink>
                ...
                <NavLink activeClassName="active" className={splitLocation[1] === "" ? "active" : ""} to="/"><h4 className="nav-link hover-underline-animation">Resume</h4></NavLink> 
            </div>
        </div>
     );
}
