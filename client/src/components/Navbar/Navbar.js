    ...
    return ( 
        <div>
            <div className="navbar-container">
                <NavLink className={splitLocation[1] === "" ? "active" : ""} to="/ "><h5 className="nav-link">Home</h5></NavLink>
                <span className="circle"></span>
                <NavLink className={splitLocation[1] === "" ? "active" : ""} to="/about"><h5 className="nav-link">About Me</h5></NavLink> 
                <span className="circle"></span>
